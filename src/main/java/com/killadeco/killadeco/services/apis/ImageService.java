...
import com.killadeco.killadeco.exceptions.ContentExc.ImageUploadException;
...
public class ImageService {
    ...
    public String uploadImage(MultipartFile file) {
        try {
            ...
            throw new ImageUploadException("Error subiendo imagen a Cloudinary: " + ex.getMessage(), ex.getMessage());
        }
    }
